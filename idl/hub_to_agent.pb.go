...
type UpgradeMirrorsRequest struct {
	PgOptions            []*PgOptions              `protobuf:"bytes,1,rep,name=PgOptions,proto3" json:"PgOptions,omitempty"`
	Tablespaces          map[int32]*TablespaceInfo `protobuf:"bytes,2,rep,name=Tablespaces,proto3" json:"Tablespaces,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}

func (m *UpgradeMirrorsRequest) Reset()         { *m = UpgradeMirrorsRequest{} }
func (m *UpgradeMirrorsRequest) String() string { return proto.CompactTextString(m) }
func (*UpgradeMirrorsRequest) ProtoMessage()    {}
func (*UpgradeMirrorsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e73bb06acc917d8, []int{1}
}

func (m *UpgradeMirrorsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpgradeMirrorsRequest.Unmarshal(m, b)
}
func (m *UpgradeMirrorsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpgradeMirrorsRequest.Marshal(b, m, deterministic)
}
func (m *UpgradeMirrorsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpgradeMirrorsRequest.Merge(m, src)
}
func (m *UpgradeMirrorsRequest) XXX_Size() int {
	return xxx_messageInfo_UpgradeMirrorsRequest.Size(m)
}
func (m *UpgradeMirrorsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_UpgradeMirrorsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_UpgradeMirrorsRequest proto.InternalMessageInfo

func (m *UpgradeMirrorsRequest) GetPgOptions() []*PgOptions {
	if m != nil {
		return m.PgOptions
	}
	return nil
...
func (m *UpgradeMirrorsRequest) GetTablespaces() map[int32]*TablespaceInfo {
	if m != nil {
...
type PgOptions struct {
	PrimaryHost                string                    `protobuf:"bytes,1,opt,name=PrimaryHost,proto3" json:"PrimaryHost,omitempty"`
	TargetVersion              string                    `protobuf:"bytes,2,opt,name=TargetVersion,proto3" json:"TargetVersion,omitempty"`
	CheckOnly                  bool                      `protobuf:"varint,3,opt,name=CheckOnly,proto3" json:"CheckOnly,omitempty"`
	UseLinkMode                bool                      `protobuf:"varint,4,opt,name=UseLinkMode,proto3" json:"UseLinkMode,omitempty"`
	TablespacesMappingFilePath string                    `protobuf:"bytes,5,opt,name=TablespacesMappingFilePath,proto3" json:"TablespacesMappingFilePath,omitempty"`
	Tablespaces                map[int32]*TablespaceInfo `protobuf:"bytes,6,rep,name=Tablespaces,proto3" json:"Tablespaces,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	SourceBinDir               string                    `protobuf:"bytes,7,opt,name=SourceBinDir,proto3" json:"SourceBinDir,omitempty"`
	SourceDataDir              string                    `protobuf:"bytes,8,opt,name=SourceDataDir,proto3" json:"SourceDataDir,omitempty"`
	SourcePort                 int32                     `protobuf:"varint,9,opt,name=SourcePort,proto3" json:"SourcePort,omitempty"`
	TargetBinDir               string                    `protobuf:"bytes,10,opt,name=TargetBinDir,proto3" json:"TargetBinDir,omitempty"`
	TargetDataDir              string                    `protobuf:"bytes,11,opt,name=TargetDataDir,proto3" json:"TargetDataDir,omitempty"`
	TargetPort                 int32                     `protobuf:"varint,12,opt,name=TargetPort,proto3" json:"TargetPort,omitempty"`
	Content                    int32                     `protobuf:"varint,13,opt,name=Content,proto3" json:"Content,omitempty"`
	DBID                       int32                     `protobuf:"varint,14,opt,name=DBID,proto3" json:"DBID,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}                  `json:"-"`
	XXX_unrecognized           []byte                    `json:"-"`
	XXX_sizecache              int32                     `json:"-"`
}
...
func (m *PgOptions) GetPrimaryHost() string {
	if m != nil {
...
func (m *PgOptions) GetCheckOnly() bool {
	if m != nil {
		return m.CheckOnly
	}
	return false
...
func (m *PgOptions) GetUseLinkMode() bool {
	if m != nil {
...
func (m *PgOptions) GetTablespacesMappingFilePath() string {
	if m != nil {
...
func (m *PgOptions) GetSourceBinDir() string {
	if m != nil {
...
func (m *PgOptions) GetSourceDataDir() string {
	if m != nil {
...
func (m *PgOptions) GetSourcePort() int32 {
	if m != nil {
		return m.SourcePort
	}
	return 0
...
func (m *PgOptions) GetTargetBinDir() string {
	if m != nil {
...
func (m *PgOptions) GetTargetDataDir() string {
	if m != nil {
...
func (m *PgOptions) GetTargetPort() int32 {
	if m != nil {
		return m.TargetPort
	}
	return 0
...
func (m *PgOptions) GetContent() int32 {
	if m != nil {
		return m.Content
	}
	return 0
...
func (m *PgOptions) GetDBID() int32 {
	if m != nil {
		return m.DBID
	}
	return 0
...
type UpgradeMirrorsReply struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *UpgradeMirrorsReply) Reset()         { *m = UpgradeMirrorsReply{} }
func (m *UpgradeMirrorsReply) String() string { return proto.CompactTextString(m) }
func (*UpgradeMirrorsReply) ProtoMessage()    {}
func (*UpgradeMirrorsReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e73bb06acc917d8, []int{3}
}

func (m *UpgradeMirrorsReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpgradeMirrorsReply.Unmarshal(m, b)
}
func (m *UpgradeMirrorsReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpgradeMirrorsReply.Marshal(b, m, deterministic)
}
func (m *UpgradeMirrorsReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpgradeMirrorsReply.Merge(m, src)
}
func (m *UpgradeMirrorsReply) XXX_Size() int {
	return xxx_messageInfo_UpgradeMirrorsReply.Size(m)
}
func (m *UpgradeMirrorsReply) XXX_DiscardUnknown() {
	xxx_messageInfo_UpgradeMirrorsReply.DiscardUnknown(m)
}

var xxx_messageInfo_UpgradeMirrorsReply proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*UpgradeMirrorsRequest)(nil), "idl.UpgradeMirrorsRequest")
	proto.RegisterMapType((map[int32]*TablespaceInfo)(nil), "idl.UpgradeMirrorsRequest.TablespacesEntry")
	...
	proto.RegisterType((*UpgradeMirrorsReply)(nil), "idl.UpgradeMirrorsReply")
...
var fileDescriptor_9e73bb06acc917d8 = []byte{
	...
	,
}
...
type AgentClient interface {
	...
	UpgradeMirrors(ctx context.Context, in *UpgradeMirrorsRequest, opts ...grpc.CallOption) (*UpgradeMirrorsReply, error)
...
func (c *agentClient) UpgradeMirrors(ctx context.Context, in *UpgradeMirrorsRequest, opts ...grpc.CallOption) (*UpgradeMirrorsReply, error) {
	out := new(UpgradeMirrorsReply)
	err := c.cc.Invoke(ctx, "/idl.Agent/UpgradeMirrors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServer interface {
	...
	UpgradeMirrors(context.Context, *UpgradeMirrorsRequest) (*UpgradeMirrorsReply, error)
...
func (*UnimplementedAgentServer) UpgradeMirrors(ctx context.Context, req *UpgradeMirrorsRequest) (*UpgradeMirrorsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpgradeMirrors not implemented")
}
...
func _Agent_UpgradeMirrors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpgradeMirrorsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).UpgradeMirrors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/idl.Agent/UpgradeMirrors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).UpgradeMirrors(ctx, req.(*UpgradeMirrorsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Agent_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpgradeMirrors",
			Handler:    _Agent_UpgradeMirrors_Handler,
		},
		{
